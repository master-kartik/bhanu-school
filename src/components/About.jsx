...
const About = () => {
  return (
    ...
    <div className='bg-gradient-to-t from-gray-900 via-gray-600 to-gray-900'>
        ...
        <div className='absolute w-full top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-6xl text-[#ffff] z-10 text-center font-bold tracking-tighter'>About Us</div>
