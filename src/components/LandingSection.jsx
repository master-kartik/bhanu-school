const LandingSection = () => {
  return (
    <div className="relative h-[65vw] lg:h-[45vw] mt-[18vw] sm:mt-[10vw] lg:mt-0 w-full overflow-hidden">
      ...
      />
      <div className="absolute top-3/4 md:top-1/3 left-1/2 transform font-EditorialNew -translate-x-1/2 -translate-y-1/2 text-2xl md:3xl lg:text-6xl text-[#f9f9f3] z-10 text-left md:text-center  leading-[0.6] lg:leading-[0.50] font-extralight select-none tracking-tight sm:leading-[0.5] w-[80vw] md:[70vw] lg:w-[60vw]">
