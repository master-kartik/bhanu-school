...
const TextCard = () => {
  const data=[{image: "https://assets.vogue.in/photos/5f8687d22ed1c0784ab7b016/master/pass/Sabyasachi%20Ajrakh%20uniforms.jpeg",
   ...
   {image: "https://www.stirworld.com/images/see/1844_Ratna_1.jpg",
    heading: "Goal",
    body: "To create ‘child safe’ environment both internally and externally, where children are respected, protected, empowered and active in their own protection, where staff are skilled, competent and well supported in meeting their protection."
   },
  ]
  return (
